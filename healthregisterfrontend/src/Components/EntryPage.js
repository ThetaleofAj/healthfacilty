...
function EntryPage(){
   ...
   useEffect(()=>{
      fetch(`http://127.0.0.1:8000/api/entry/${params.entryId}`,{
         method: 'GET',
      })
      .then(res=>res.json())
      .then(
   ...
   //Edit the main model
   const EditMainModel =()=>{
      fetch(`http://127.0.0.1:8000/api/editmain/${params.entryId}`,{
         method: 'PUT',
         headers: {
   ...
   //Adding a Service
   const AddService =()=>{
      fetch('http://127.0.0.1:8000/api/addservices/',{
         method: 'POST',
         headers: {
            'Content-Type' : 'application/json', 
      },
 ...
 const AddEquipment=()=>{
   fetch('http://127.0.0.1:8000/api/addequipment/',{
      method: 'POST',
      headers: {
         'Content-Type' : 'application/json', 
   },
 ...
 //Adding new contact
 const AddContact=()=>{
   fetch('http://127.0.0.1:8000/api/addcontact/',{
      method: 'POST',
      headers: {
         'Content-Type' : 'application/json', 
   },
...
const AddOperatingHours=()=>{
   fetch('http://127.0.0.1:8000/api/addhours/',{
      method: 'POST',
      headers: {
         'Content-Type' : 'application/json', 
   },
